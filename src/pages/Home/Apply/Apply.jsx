...
export default function Apply() {
    return <>
        <div className="container mb-5">
            <div className="row gap-5 gap-lg-0 ApplyContain">
                <div className="col-lg-6 hrAfter d-flex">
                    <div className='px-2'>
                        <div className='bg-warning-subtle p-4 rounded-circle'>
                    ...
                    <div className='px-3'>
                        <div className='fs-5 my-1 fw-semibold'>Become an Instructor</div>
                        <p>Teach what you love. Learned gives you neccessary tools to become an instructor.</p>
                        <button className="btn btn-light bg-secondary-subtle rounded-0">Start Teaching</button>
                    </div>
                </div>
                <div className="col-lg-6 d-flex">
                    ...
                    <div className='px-3'>
                        <div className='fs-5 my-1 fw-semibold'>Apply for Admission</div>
                        <p>Course completed? Then its time apply the certificate Do it in simplesteps with Learned.</p>
                        <button className="btn btn-primary rounded-0">Apply Now</button>
                    </div>
                </div>
            </div>
        </div>
